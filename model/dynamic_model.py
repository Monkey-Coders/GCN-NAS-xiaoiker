...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3, weights = None):
        ...
        self.l8 = TCN_GCN_unit(128, 256, A, stride=2, weights=weights[4])
        self.l9 = TCN_GCN_unit(256, 256, A, weights=weights[5])
        ...
        self.layers = [self.l1, self.l2, self.l5, self.l6, self.l8, self.l9]
